...
const words = ['Full Stack Developer', 'Mern Stack Developer', 'AI/ML Learner', 'Problem Solver'];
let wordIndex = 0;
let charIndex = 0;
...
const navRoles = ['Mern Developer', 'React Developer', 'AI/ML Learner'];
let navWordIndex = 0;
let navCharIndex = 0;
...
console.log('%c📧 shubhingale23052004@gmail.com', 'font-size: 12px; color: #6b7280;');
